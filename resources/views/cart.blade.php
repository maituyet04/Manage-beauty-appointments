            ...
            <ul class="header-cart-wrapitem w-full">
                @if (count($beauties) > 0)
                    @foreach($beauties as $key => $beauty)
                        @php
                            $price = \App\Helpers\Helper::price($beauty->price, $beauty->price_sale);
                            $sumPriceCart += $beauty->price_sale != 0 ? $beauty->price_sale : $beauty->price;
                        @endphp
                        <li class="header-cart-item flex-w flex-t m-b-12">
                            <div class="header-cart-item-img">
                                <img src="{{ $beauty->thumb }}" alt="IMG">
                            </div>
