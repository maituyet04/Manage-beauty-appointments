...
@section('content')
    <div class="container p-t-80">
        <div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
            ...
            <a href="/danh-muc/{{ $beauty->menu->id }}-{{ Str::slug($beauty->menu->name) }}.html"
                                    ...
                                    <div class="slick-track" style="opacity: 1; width: 1539px;">
                                        <div class="item-slick3 slick-slide slick-current slick-active"
                                            ...
                                            <div class="wrap-pic-w pos-relative">
                                                <img src="{{ $beauty->thumb }}" alt="IMG-PRODUCT">
                                ...
                                <div class="size-204 flex-w flex-m respon6-next">
                                    <form action="/add-cart" method="post">
                                        @if ($beauty->price !== NULL)
                                            ...
                                            <input type="hidden" name="product_id" value="{{ $beauty->id }}">
                                        @endif
                                        @csrf
                                    </form>
                                </div>
